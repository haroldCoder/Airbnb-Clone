        ...
        return(
            <div className="d-flex bg-white" style={{flexFlow: "column"}}>
                <header className='z-50 grid grid-cols-3 shadow-lg shadow-gray-100 pt-6 pb-2 pl-2 md:px-10 w-100'>
                    ...
                    <div className='flex items-center md:border-1 rounded-full py-2 pr-5 shadow-xl shadow-gray-400'>
                    ...
                    <div className='flex space-x-4 items-center justify-end'>
                        ...
                        <a target='_blank' href='https://website-harold-koderx.netlify.app/'><GlobeAltIcon className='h-6 cursor-pointer'/></a>
                ...
                <header className='d-flex nav pb-2 md:px-10 shadow-md shadow-slate-500 pl-10' style={{width: "100%"}}>
                    <div className='flex relative items-center p-1 justify-between' style={{width: "25%", left: "36%"}}>
                        <Link to="/create" className='outline-none' style={{textDecoration: "none"}}><div className='text-blue-00 cursor-pointer hover:text-gray-400' style={{fontSize: "14px", fontWeight: "600"}}>create</div></Link>
                        <Link to="/about" className='outline-none' style={{textDecoration: "none"}}><div className='text-blue-00 cursor-pointer hover:text-gray-400' style={{fontSize: "14px", fontWeight: "600"}}>about</div></Link>
                        <Link to="/help" className='outline-none' style={{textDecoration: "none"}}><div className='text-blue-00 cursor-pointer hover:text-gray-400' style={{fontSize: "14px", fontWeight: "600"}}>help</div></Link>
                    </div>
                </header>
            </div>
        );
